---
description: "为测 args 字段是否能传过去，用 short 字符串调 update_page 直接覆盖了 v13 整页；同时定位到 LLM 长 args（17k 字符）会整体丢失"
---
...
- → 原则：`各角色目录/AI工程/原则/2026-05-09-写入工具不要在生产对象上做test.md`
- → 原则：`各角色目录/AI工程/原则/2026-05-09-LLM工具调用args超阈值会丢失.md`
