Create one clean full-body reference sprite for Codex pet Anya.

Pet identity: Preserve the existing Anya identity exactly: pink-haired pixel humanoid companion, same face, palette, proportions, outfit, and style. Upgrade only by adding natural gaze directions..
