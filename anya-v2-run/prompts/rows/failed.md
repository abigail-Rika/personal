...
Identity: same pet in every frame: Preserve the existing Anya identity exactly: pink-haired pixel humanoid companion, same face, palette, proportions, outfit, and style. Upgrade only by adding natural gaze directions.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
