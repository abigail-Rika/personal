...
Identity: same pet in every frame: Preserve the existing Anya identity exactly: pink-haired pixel girl with black cat-ear bows, green eyes, black-and-gold outfit, white shoes, and the small round green companion held at her front. Add subtle, anatomically grounded gaze directions while keeping her lower body and prop attachment stable.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `pixel`: Pixel-art-adjacent digital mascot with a chunky silhouette, simple dark outline, limited palette, flat cel shading, and visible stepped edges. User style notes: Upgrade existing approved 8x9 pixel pet to v2; preserve all standard rows and visual identity..
